...
public class C03_Senkronization extends TestBaseBeforeAfter {
    ...
    public void imlicitlyWaitTest1() {
        ...
        assertTrue(driver.findElement(By.xpath("//*[text()=\"It's gone!\"]")).isDisplayed());
        //Add buttonuna basin
        driver.findElement(By.xpath("//*[text()='Add']")).click();
        //It’s back mesajinin gorundugunu test edin
        assertTrue(driver.findElement(By.xpath("//*[@id='message']")).isDisplayed());
    }
    ...
    public void explicitWaitTest2() {
        ...
        assertTrue(itsGoneWE.isDisplayed());
        /*
        ...
        assertTrue(itsBackWE.isDisplayed());
